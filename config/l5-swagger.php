...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * pattern: string       $pattern File patterns that the finder should find files.
             */
            'pattern' => '*.php',

            /*
             * Absolute paths to directories that should be exclude from scanning
             * @note This option overwrites `paths.excludes`
             * @see \OpenApi\Analysis::exclude
             */
            'exclude' => [],
